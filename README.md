...
Se han tenido en cuenta las recomendaciones de accesibilidad para cumplir con WCAG 2.1 nivel AA, y se aplican, de forma parcial, criterios de nivel AAA. Se ha cuidado el contraste de colores en modo oscuro y claro, y la facilidad de uso en pantallas táctiles, con áreas de toque grandes y guías visuales claras. También se incuyen avisos de enlaces en nueva pestaña. El mapa de imagen se oculta en modo "pantalla estrecha", por lo que no requiere de más arreglos de accesibilidad.
Se ha incluido un enlace de "salto al contenido principal" como medida preventiva de accesibilidad, aunque el tamaño reducido del sitio hace que su impacto práctico sea limitado. Me parece, sin embargo, una buena práctica
